            ...
            <div class="col-md-12">
                ...
                <?php
                        ...
                        if(isset($_POST['submit'])) {
                            ...
                            $due_date = mysqli_real_escape_string($koneksi, $_POST['tanggal']);
                            $user_id = $_SESSION['users']['id'];
                            $status = mysqli_real_escape_string($koneksi, $_POST['status']);

                            $query = mysqli_query($koneksi, "UPDATE tasks set category_id='$category_id', tasks='$tasks', priority='$priority', tanggal='$due_date', user_id='$user_id', status='$status' WHERE id=$id");
